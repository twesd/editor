						 ...
						 position2di position)
{
	...
	_defaultPositionCenter.X = _position.X + (_sizeTexture.Width / 2) - (_sizeTextureCenter.Width / 2);
	_defaultPositionCenter.Y = _position.Y + (_sizeTexture.Height / 2) - (_sizeTextureCenter.Height / 2);
...
void ControlCircle::fillCirleDesc(CONTROL_CIRCLE_STATE state)
{
	...
	if(SharedParams.DisplayPos == DisplayPosition_Horizontal_Left)
		_controlCircleDesc.Angle += 90;
