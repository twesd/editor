...
namespace UnitEngineUI
{
    public partial class EditorBehaviorIrrDocument : DockContent
    {
        ...
        public EditorBehaviorIrrDocument(TransactionManager transManager)
        {
            InitializeComponent();
        ...
        public void UpdateModel(UnitAction action, UnitBehavior container)
        {
            ...
            //
            UnitAnimation animation = container.Animations.Find(x => x.Id == action.AnimationId);
        ...
        public void UpdateAnimation(UnitAnimation animation)
        {
            // Устанавливаем анимацию
            //
            if (_model != null)
            {
                if (animation != null)
                {
                    _model.SetLoopMode(animation.Loop);
                    _model.SetAnimationSpeed(animation.Speed);
                    _model.SetFrameLoop(
                        animation.StartFrame * Common.Constants.AnimationFrame,
                        animation.EndFrame * Common.Constants.AnimationFrame);
                }
                else
                {
